...
--
-- Host: localhost
-- Generation Time: 29-Maio-2018 às 02:51
...
--
-- Estrutura da tabela `events_stages_current`
--
...
--
-- Estrutura da tabela `events_stages_history`
--
...
--
-- Estrutura da tabela `events_stages_history_long`
--
...
--
-- Estrutura da tabela `events_stages_summary_by_account_by_event_name`
--
...
--
-- Estrutura da tabela `events_stages_summary_by_host_by_event_name`
--
...
--
-- Estrutura da tabela `events_stages_summary_by_thread_by_event_name`
--
...
--
-- Estrutura da tabela `events_stages_summary_by_user_by_event_name`
--
...
--
-- Estrutura da tabela `events_stages_summary_global_by_event_name`
--
...
--
-- Estrutura da tabela `events_statements_current`
--
...
--
-- Estrutura da tabela `events_statements_history`
--
...
--
-- Estrutura da tabela `events_statements_history_long`
--
...
--
-- Estrutura da tabela `events_statements_summary_by_account_by_event_name`
--
...
--
-- Estrutura da tabela `events_statements_summary_by_digest`
--
...
--
-- Estrutura da tabela `events_statements_summary_by_host_by_event_name`
--
...
--
-- Estrutura da tabela `events_statements_summary_by_thread_by_event_name`
--
...
--
-- Estrutura da tabela `events_statements_summary_by_user_by_event_name`
--
...
--
-- Estrutura da tabela `events_statements_summary_global_by_event_name`
--
...
--
-- Estrutura da tabela `events_waits_summary_by_account_by_event_name`
--
...
--
-- Estrutura da tabela `events_waits_summary_by_host_by_event_name`
--
...
--
-- Estrutura da tabela `events_waits_summary_by_user_by_event_name`
--
...
--
-- Estrutura da tabela `host_cache`
--
...
--
-- Estrutura da tabela `objects_summary_global_by_type`
--
...
--
-- Estrutura da tabela `session_account_connect_attrs`
--
...
--
-- Estrutura da tabela `session_connect_attrs`
--
...
--
-- Estrutura da tabela `setup_actors`
--
...
--
-- Estrutura da tabela `setup_objects`
--
...
--
-- Estrutura da tabela `socket_instances`
--
...
--
-- Estrutura da tabela `socket_summary_by_event_name`
--
...
--
-- Estrutura da tabela `socket_summary_by_instance`
--
...
--
-- Estrutura da tabela `table_io_waits_summary_by_index_usage`
--
...
--
-- Estrutura da tabela `table_io_waits_summary_by_table`
--
...
--
-- Estrutura da tabela `table_lock_waits_summary_by_table`
--
